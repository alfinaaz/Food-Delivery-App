...
export default function Navbar() {
    ...
    return (
        <div>
            <nav class="navbar navbar-expand-lg" style={{backgroundColor:"#987456"}}>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav  ms-auto">
                            ...
                            {currentUser ? (<div class="dropdown  mt-2">
                                <a className='dropdown-toggle' href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false" style={{color:"black"}}>
                                    {currentUser.name}
                                </a>
